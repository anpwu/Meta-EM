...
class ToyModelSelectionMethod(AbstractMethod):
    def __init__(self, train_dict, enable_cuda=False):
        ...
        g_models = [
            MLPModel(input_dim=train_dict['stage2_dim'], layer_widths=train_dict['stage2_layers'], activation=nn.LeakyReLU).double(),
        ]
        f_models = [
            MLPModel(input_dim=train_dict['stage1_dim'], layer_widths=train_dict['stage1_layers'], activation=nn.LeakyReLU).double(),
        ]
        ...
        learning_eval = FHistoryLearningEvalSGDNoStop(
            num_epochs=3000, eval_freq=20, print_freq=100, batch_size=1000)
    ...
    def fit(self, x_train, z_train, y_train, x_dev, z_dev, y_dev,
        ...
        learner = SGDLearningDevF(
            ...
            max_num_epochs=4000, eval_freq=20, batch_size=1000,
